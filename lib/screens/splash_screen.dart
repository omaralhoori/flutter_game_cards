...
class _SplashScreenState extends State<SplashScreen> {
  ...
  Widget build(BuildContext context) {
    return SplashScreenView(
      navigateTo: appStore.isLoggedIn ? DashboardScreen():SignInScreen(), //  (appStore.isFirstTime) ? WalkThroughScreen() :DashboardScreen() ,// (appStore.isFirstTime) ? WalkThroughScreen() : 
      imageSize: 200,
      imageSrc: ic_logo,
      text: locale.appName,
